 ...
 * - without 't'-prefix, e.g. putchar, puts, printf, getchar, gets
 * - with 't'-prefix, e.g. tputchar, tputs, tprintf, tgetchar, tgets. 
...
int main(void) {
    ...
    printf("Hello from terminal %d with address %p\n", 0, (void *)term0);
